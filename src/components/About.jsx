                ...
                <div className="grid md:grid-cols-2 gap-10 items-center">
                    <div>
                        ...
                        <div className="mt-6 grid grid-cols-2 gap-4">
                            <div className="p-5 rounded-2xl border dark:border-white/10 shadow-sm">
                                <p className="text-3xl font-bold">10k+</p>
                                <p className="opacity-70">Happy riders</p>
                            </div>
                            <div className="p-5 rounded-2xl border dark:border-white/10 shadow-sm">
                                <p className="text-3xl font-bold">1k+</p>
                                <p className="opacity-70">Verified owners</p>
                            </div>
                        </div>
                    </div>
                    <div>
                        <Box className="rounded-3xl overflow-hidden shadow-2xl border border-white/10 dark:border-white/5">
                            <img
